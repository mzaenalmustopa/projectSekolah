...
public class MasterRuanganController {
    ...
    public ModelAndView addModal(){
        var view = new ModelAndView("pages/master/ruangan/add");
        return view;
    }

    @PostMapping("/save")
    public ResponseEntity<Response>save(@RequestBody @Valid RuanganRequest request){
    ...
    public ResponseEntity<Response> update(@RequestBody @Valid RuanganRequest request,@PathVariable("id") Integer id){
